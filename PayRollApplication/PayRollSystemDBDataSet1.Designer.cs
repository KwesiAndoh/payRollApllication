...
namespace PayRollApplication {
    ...
    public partial class PayRollSystemDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(int UserId, string UserName, string Password, string Role, string RoleDescription) {
...
namespace PayRollApplication.PayRollSystemDBDataSet1TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([UserId], [UserName], [Password], [Role], [RoleDescrip" +
                "tion]) VALUES (@UserId, @UserName, @Password, @Role, @RoleDescription);\r\nSELECT " +
                "UserId, UserName, Password, Role, RoleDescription FROM Users WHERE (UserId = @Us" +
                "erId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [UserId] = @UserId, [UserName] = @UserName, [Password] = @Password, [Role] = @Role, [RoleDescription] = @RoleDescription WHERE (([UserId] = @Original_UserId) AND ((@IsNull_UserName = 1 AND [UserName] IS NULL) OR ([UserName] = @Original_UserName)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Role = 1 AND [Role] IS NULL) OR ([Role] = @Original_Role)) AND ((@IsNull_RoleDescription = 1 AND [RoleDescription] IS NULL) OR ([RoleDescription] = @Original_RoleDescription)));
SELECT UserId, UserName, Password, Role, RoleDescription FROM Users WHERE (UserId = @UserId)";
        ...
        public virtual int Fill(PayRollSystemDBDataSet1.UsersDataTable dataTable) {
        ...
        public virtual PayRollSystemDBDataSet1.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PayRollSystemDBDataSet1.UsersDataTable dataTable = new PayRollSystemDBDataSet1.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PayRollSystemDBDataSet1.UsersDataTable dataTable) {
        ...
        public virtual int Insert(int UserId, string UserName, string Password, string Role, string RoleDescription) {
            ...
            if ((RoleDescription == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(RoleDescription));
            }
        ...
        public virtual int Update(int UserId, string UserName, string Password, string Role, string RoleDescription, int Original_UserId, string Original_UserName, string Original_Password, string Original_Role, string Original_RoleDescription) {
            ...
            if ((RoleDescription == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(RoleDescription));
            }
            ...
            if ((Original_RoleDescription == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_RoleDescription));
            }
        ...
        public virtual int Update(string UserName, string Password, string Role, string RoleDescription, int Original_UserId, string Original_UserName, string Original_Password, string Original_Role, string Original_RoleDescription) {
            return this.Update(Original_UserId, UserName, Password, Role, RoleDescription, Original_UserId, Original_UserName, Original_Password, Original_Role, Original_RoleDescription);
        }
    }
